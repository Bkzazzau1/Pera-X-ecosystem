...
- No devnet program update was performed.
...
Do not update devnet or migrate reserve balances unless all commands pass and the 1,000-PEX community-vault trial succeeds.
